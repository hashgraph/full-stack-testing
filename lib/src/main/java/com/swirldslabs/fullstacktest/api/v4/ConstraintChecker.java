...
/**
 * A check based constraint verifier.
 * */
public sealed interface ConstraintChecker extends ConstraintVerifier permits PreCondition, PostCondition {
    /**
     ...
     * */
    void check() throws AssertionError, IncompleteExecutionException, InterruptedException;
}
