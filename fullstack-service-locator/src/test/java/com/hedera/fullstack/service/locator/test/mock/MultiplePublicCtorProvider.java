...
public class MultiplePublicCtorProvider implements ServiceLocationProvider {
    /**
    ...
    public <S> Iterator<ServiceSupplier<S>> iteratorFor(Class<S> serviceClass) {
        return Collections.singletonList(
                        (ServiceSupplier<S>) new ServiceSupplier<CtorService>(MultiplePublicCtorService.class))
                .iterator();
    }
