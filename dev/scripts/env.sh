...
readonly PROMETHEUS_OPERATOR_DIR="${SETUP_CHART_DIR}/charts/prometheus-operator"
readonly PROMETHEUS_VERSION=v0.67.1 # run telmetry.sh update-prometheus-operator function to download and helmify a newer version of prometheus-operator
